...
const STEPS = [
    {
        ...
        descripion: 'Choose an image for your case',
        url: '/upload',
    },
    {
        name: 'Step 2: Customize design',
        descripion: 'Make the case yours',
        url: '/design',
    },
    {
        name: 'Step 3: Summary',
        descripion: 'Review your final design',
        url: '/preview',
    }
]
                ...
                <div>
                    ...
                    <span 
                        ...
                        <span className='ml-4 h-full mt-0.5 flex min-w-0 flex-col justify-center'>
                            <span className={cn("text-small font-semibold text-zinc-700", {
                    ...
                    {/* separator */}
                    { i !== 0 ? (
                        <div className='absolute inset-0 w-3 lg:block'>
                            <svg
