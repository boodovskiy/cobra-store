    ...
    <div className="bg-white">
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 sm:py-24 lg:px-8 ">
            <div className="max-w-xl">
                ...
                <p className="mt-2 text-base text-zinc-500">We've recieved your order and are now processing it.</p>
            ...
            <div className="mt-10 border-t border-zinc-200">
                <div className="mt-10 flex flex-auto flex-col">
                    <h4 className="font-semibold text-zinc-900">Your made a greate choice!</h4>
                    <p className="mt-2 text-sm text-zinc-600">
                        We at CaseCobra believe that a phone case doesn't only need to look good, but also last your for the years to come.
                        We offer a 5-year pring guarantee: If you case isn't of the highest quality, we'll replace it for free.
                    </p>
                </div>
            </div>
