...
import { BASE_PRICE, COLORS, MODELS } from '@/validators/option-validator'
    ...
    useEffect(() => {
        const fetchUser = async () => {
          try {
            ...
            setUser(fetchedUser) // Store the user data in state
          } catch (error) {
         ...
         <div className="mt-20 grid grid-cols-1 text-sm sm:grid-cols-12 sm:grid-rows-1 sm:gap-x-6 md:gap-x-8 lg:gap-x-12">
            ...
            <div className="mt-6 sm:col-span-9 sm:mt-0 md:row-end-1">
                ...
                <div className="mt-3 flex items-center gap-1.5 text-base">
                    <Check className='h-4 w-4 texg-green-500'/>
            ...
            <div className="sm:col-span-12 md:col-span-9 text-base">
                ...
                <div className="mt-8">
                    <div className="bg-gray-300 p-6 sm:rounded-lg sm:p-8">
