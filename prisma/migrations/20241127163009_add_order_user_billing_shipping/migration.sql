...
CREATE TABLE "BilliAddress" (
    ...
    CONSTRAINT "BilliAddress_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "Order" ADD CONSTRAINT "Order_billingAddressId_fkey" FOREIGN KEY ("billingAddressId") REFERENCES "BilliAddress"("id") ON DELETE SET NULL ON UPDATE CASCADE;
